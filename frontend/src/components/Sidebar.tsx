...
// import { X, Calendar, Mail, FileText, GitBranch, Settings, LogOut, Shield, Activity, Presentation, ClipboardList } from 'lucide-react';
...
//     { id: 'sheets', name: 'Google Sheets', icon: FileText, description: 'View and manage your spreadsheets', connected: integrations.sheets },
//     { id: 'slides', name: 'Google Slides', icon: Presentation || FileText, description: 'Access your presentations', connected: integrations.slides },
//     { id: 'forms', name: 'Google Forms', icon: ClipboardList || FileText, description: 'Access your forms and responses', connected: integrations.forms },
//   ];
